<template>
		...
		<el-form label-position="right" :model="query" class="form p_4" label-width="120">
			<el-row class="rows row1">
					...
					<el-form-item label="车主姓名">
									<el-select v-model="query.owners_name">
	...
	<el-row class="rows row2">
		...
		<el-table :data="list" @selection-change="selectionChange" @sort-change="$sortChange" style="width: 100%" id="dataTable">
			...
			<el-table-column fixed="right" label="操作" min-width="200" v-if="user_group == '管理员' || $check_action('/message_notification/table','set') || $check_action('/message_notification/view','set') || $check_action('/message_notification/view','get') || $check_action('//table','add') || $check_action('//view','add')" >
