				...
				<el-col>
					<el-form :model="form" ref="form" label-width="80px" class="form">
						...
						<el-form-item label="身份" prop="user_group">
							...
							<!-- 车主用户 -->
						<form_car_owners_and_users v-if="form.user_group === '车主用户'" :form="form_sub" ></form_car_owners_and_users>
								<!-- 维护用户 -->
						<form_maintaining_users v-if="form.user_group === '维护用户'" :form="form_sub" ></form_maintaining_users>
								<!-- 检测用户 -->
						<form_detecting_users v-if="form.user_group === '检测用户'" :form="form_sub" ></form_detecting_users>
...
<script>
	import mixin from "@/mixins/page.js";
		/* 车主用户 */
	import form_car_owners_and_users from "@/components/diy/form_car_owners_and_users";
			/* 维护用户 */
	import form_maintaining_users from "@/components/diy/form_maintaining_users";
			/* 检测用户 */
	import form_detecting_users from "@/components/diy/form_detecting_users";
	...
	export default {
		...
		components:{
				/* 车主用户 */
			form_car_owners_and_users,
					/* 维护用户 */
			form_maintaining_users,
					/* 检测用户 */
			form_detecting_users,
										}
	}
</script>
